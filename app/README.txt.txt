...
1. **Registro automático de URLs 404**: Cada vez que un usuario intenta acceder a una URL no existente, el plugin lo registra automáticamente.
2. **Exportación en CSV y TXT**: Los administradores pueden exportar fácilmente la lista de URLs que generan errores 404 en formatos CSV y TXT. El formato CSV también incluye la fecha en que se detectó el error.
3. **Fácil acceso desde el panel de administración**: Una vez instalado el plugin, encontrarás una opción en el menú de administración para acceder a las funcionalidades del plugin.
